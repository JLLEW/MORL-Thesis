...
def generate_data_sp(scenario):
    if scenario == "sp_extended":
        tickers = ['AAPL',
            'MSFT',
            'JNJ',
            'PG',
        ...
        stock_data = download_stock_data(start_date='2012-06-01', end_date='2024-01-01')
...
def generate_data(scenario):
    if scenario == "sp" or scenario == "sp_extended":
        return generate_data_sp(scenario)
